...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        //       – Print them: \n You get a \n" + <randomCard> + "\n and a \n" + <randomCard>
        int playerNum1 = drawRandomCard();
        int playerNum2 = drawRandomCard();
        String playerCard1 = cardString(playerNum1);
        String playerCard2 = cardString(playerNum2);
        ...
        int playerValue = handConversion(playerNum1) + handConversion(playerNum2);
        ...
        if (hitStay.equals("hit")){
            ...
            String newCard = cardString(newNum);
            playerValue += handConversion(newNum);
            System.out.println("\n You get a \n" + newCard);
            System.out.println("Your new total is: " + playerValue);
        }
     ...
     */
     ...
     public static String cardString(int cardNumber) {
        ...
        switch(cardNumber) {
            ...
            "  | |%%%|\n"+ 
            "  |_%%%>|\n";
            default: return "Unable to get card";
    ...
    public static int handConversion(int num){
        if (num < 10){
            return num;
        } else {
            return 10; 
